...
## RESULT:
Thus the Java program to perform arithmetic operations using variables and operators was implemented and executed successfully.# Ex.No:1(A) INTRODUCTION TO JAVA PROGRAMMING, DATA TYPES, VARIABLES AND OPERATORS
